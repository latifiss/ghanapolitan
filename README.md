...
1. **Clone the repo:**
   ...
   ```bash
   git clone https://github.com/latifiss/ghanapolitan.git
   cd ghanapolitan
   ```
...
🎨 `styles/` – Global and utility styling
...
This Next.js app can be deployed to platforms like **Vercel**, **Netlify**, or **Cloudflare Pages**.
