    ...
    const upcomingEvents = [
        {
            ...
            date: earnings?.events?.next_earnings_date ? new Date(earnings.events.next_earnings_date).toLocaleDateString() : 'TBA',
            description: 'Q4 2024 Earnings Announcement'
        },
        {
            title: 'Dividend Payment',
            date: dividends?.events?.next_dividend_pay_date ? new Date(dividends.events.next_dividend_pay_date).toLocaleDateString() : 'TBA',
            description: 'Next Dividend Payment Date'
        },
        {
