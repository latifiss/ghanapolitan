    ...
    if (!initialData) {
          ...
          const results = await Promise.all(
            TICKERS.map(async (t) => {
              try {
                ...
                const stats = res?.data?.statistics ?? res?.statistics ?? res?.data ?? null;
                return { t, stats };
              } catch (err) {
      ...
      const fetchData = async () => {
        try {
          ...
          setJpyData(jpyRes);
          setUsdInterbankData(usdInterbankRes);
          setEurInterbankData(eurInterbankRes);
          setGbpInterbankData(gbpInterbankRes);
          setGoldData(goldRes);
          ...
          try {
            const [currencyRes, commodityRes, cryptoRes, treasuryRes] = await Promise.all([
            ...
            setCurrencyArticles(currencyRes?.data?.articles ?? []);
            setCommodityArticles(commodityRes?.data?.articles ?? []);
            setCryptoArticles(cryptoRes?.data?.articles ?? []);
            setTreasuryArticles(treasuryRes?.data?.articles ?? []);
          } catch (err) {
      ...
      <Wrapper>
        <ChartItem>
          <Header>
            ...
            <Currency>
              ...
              <BOGItem 
                ...
                value={usdInterbankData?.currentPrice?.toFixed(2) || ' '} 
                change={usdInterbankData?.percentage_change || 0} 
              />
            </Currency>
          </Header>
          ...
          <OtherContainer>
            ...
            <CurrencyItem image="/assets/forex/eur-ghs.png" label="Euro to Cedi" code="EURGHS" value={eurData?.currentPrice?.toFixed(2) || ' '} change={eurData?.percentage_change || 0} />
            <BOGItem 
              label="BOG Interbank Rate" 
              code="Euro to Cedi" 
              value={eurInterbankData?.currentPrice?.toFixed(2) || ' '} 
              change={eurInterbankData?.percentage_change || 0} 
            />
            <CurrencyItem image="/assets/forex/gbp-ghs.png" label="Pounds to Cedi" code="GBPGHS" value={gbpData?.currentPrice?.toFixed(2) || ' '} change={gbpData?.percentage_change || 0} />
            <BOGItem 
              label="BOG Interbank Rate" 
              code="Pounds to Cedi" 
              value={gbpInterbankData?.currentPrice?.toFixed(2) || ' '} 
              change={gbpInterbankData?.percentage_change || 0} 
            />
            <CurrencyItem image="/assets/forex/cny-ghs.png" label="Yuan to Cedi" code="CNYGHS" value={cnyData?.currentPrice?.toFixed(2) || ' '} change={cnyData?.percentage_change || 0} />
            <CurrencyItem image="/assets/forex/ghs-ngn.png" label="Cedi to Naira" code="GHSNGN" value={ghsNgnData?.currentPrice?.toFixed(2) || ' '} change={ghsNgnData?.percentage_change || 0} />
            <CurrencyItem image="/assets/forex/ghs-xof.png" label="Cedi to Cfa" code="GHSXOF" value={ghsXofData?.currentPrice?.toFixed(2) || ' '} change={ghsXofData?.percentage_change || 0} />
            <CurrencyItem image="/assets/forex/cad-ghs.png" label="Canadian dollar to Cedi" code="CADGHS" value={cadData?.currentPrice?.toFixed(2) || ' '} change={cadData?.percentage_change || 0} />
            <CurrencyItem image="/assets/forex/ghs-zar.png" label="Cedi to Rand" code="GHSZAR" value={ghsZarData?.currentPrice?.toFixed(2) || ' '} change={ghsZarData?.percentage_change || 0} />
            <CurrencyItem image="/assets/forex/jpy-ghs.png" label="Yen to Cedi" code="JPYGHS" value={jpyData?.currentPrice?.toFixed(2) || ' '} change={jpyData?.percentage_change || 0} />
          </OtherContainer>
  ...
  : ' '}
        ...
        <ChartItem>
          ...
          <OtherContainer>
            ...
            <CurrencyItem label="Cocoa" code="USD/T" value={`$${cocoaData?.currentPrice?.toFixed(2) || ' '}`} change={cocoaData?.percentage_change || 0} />
            <CurrencyItem label="Brent" code="USD/Bbl" value={`$${brentData?.currentPrice?.toFixed(2) || ' '}`} change={brentData?.percentage_change || 0} />
            <CurrencyItem label="Crude oil" code="USD/Bbl" value={`$${crudeData?.currentPrice?.toFixed(2) || ' '}`} change={crudeData?.percentage_change || 0} />
            <CurrencyItem label="Coffee" code="USD/lbs" value={`$${coffeeData?.currentPrice?.toFixed(2) || ' '}`} change={coffeeData?.percentage_change || 0} />
            <CurrencyItem label="Copper" code="USD/lbs" value={`$${copperData?.currentPrice?.toFixed(2) || ' '}`} change={copperData?.percentage_change || 0} />
            <CurrencyItem label="Steel" code="CNY/T" value={`¥${steelData?.currentPrice?.toFixed(2) || ' '}`} change={steelData?.percentage_change || 0} />
            <CurrencyItem label="Lithium" code="CNY/T" value={`¥${lithiumData?.currentPrice?.toFixed(2) || ' '}`} change={lithiumData?.percentage_change || 0} />
            <CurrencyItem label="Rubber" code="USD Cents / Kg" value={`$${rubberData?.currentPrice?.toFixed(2) || ' '}`} change={rubberData?.percentage_change || 0} />
          </OtherContainer>
  ...
  : ' '}
        ...
        <ChartItem>
          <Header>
            ...
            <Currency>
              <StockItem
                ...
                label="Bitcoin"
                code="Bitcoin"
                value={`$${bitcoinData?.current_price?.toFixed(2) || ' '}`}
          ...
          <OtherContainer>
            ...
            <StockItem image="/assets/crypto/ethereum.svg" label="Ethereum" code="Ethereum" value={`$${ethereumData?.current_price?.toFixed(2) || ' '}`} change={Number((ethereumData?.price_change_percentage_24h ?? 0).toFixed(2))} />
            <StockItem image="/assets/crypto/tether.svg" label="Tether" code="Tether" value={`$${tetherData?.current_price?.toFixed(2) || ' '}`} change={Number((tetherData?.price_change_percentage_24h ?? 0).toFixed(2))} />
            <StockItem image="/assets/crypto/xrp.svg" label="XRP" code="XRP" value={`$${xrpData?.current_price?.toFixed(2) || ' '}`} change={Number((xrpData?.price_change_percentage_24h ?? 0).toFixed(2))}/>
            <StockItem image="/assets/crypto/binance.svg" label="Binance" code="Binance" value={`$${binanceData?.current_price?.toFixed(2) || ' '}`} change={Number((binanceData?.price_change_percentage_24h ?? 0).toFixed(2))} />
            <StockItem image="/assets/crypto/chainlink.svg" label="Chainlink" code="Chainlink" value={`$${chainlinkData?.current_price?.toFixed(2) || ' '}`} change={Number((chainlinkData?.price_change_percentage_24h ?? 0).toFixed(2))} />
            <StockItem image="/assets/crypto/cardano.svg" label="Cardano" code="Cardano" value={`$${cardanoData?.current_price?.toFixed(2) || ' '}`} change={Number((cardanoData?.price_change_percentage_24h ?? 0).toFixed(2))}
 />
            <StockItem image="/assets/crypto/dogecoin.svg" label="Dogecoin" code="Dogecoin" value={`$${dogecoinData?.current_price?.toFixed(2) || ' '}`}
              change={Number((dogecoinData?.price_change_percentage_24h ?? 0).toFixed(2))}
              />
          </OtherContainer>
